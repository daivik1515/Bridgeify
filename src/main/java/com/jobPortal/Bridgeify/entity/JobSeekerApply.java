...
public class JobSeekerApply implements Serializable {
    ...
    public JobSeekerApply(Date applyDate, String coverLetter) {
        this.applyDate = applyDate;
        this.coverLetter = coverLetter;
    }

    public JobSeekerApply(int id, Date applyDate, String coverLetter, JobSeekerProfile userId, JobPostActivity job) {
        this.id = id;
        this.applyDate = applyDate;
        this.coverLetter = coverLetter;
        this.userId = userId;
