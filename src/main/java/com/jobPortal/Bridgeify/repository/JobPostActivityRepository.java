...
import com.jobPortal.Bridgeify.entity.IRecruiterJobsDto;
import com.jobPortal.Bridgeify.entity.JobPostActivity;
import com.jobPortal.Bridgeify.entity.RecruiterJobsDto;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity,Integer> {
    ...
    List<IRecruiterJobsDto> getRecruiterJobs(@Param("recruiter") int recruiter);
}
